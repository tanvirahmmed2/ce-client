...
const Sidebar = () => {
  ...
  console.log(sidebar)
  return (
    <div className={`w-[300px] min-h-screen fixed bg-gray-600 z-50 right-0 flex md:hidden ${sidebar ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-500 ease-in-out flex-col items-end justify-start gap-4 text-white px-6 py-6`}>
      ...
      <div className='w-  flex flex-col items-end justify-center gap-2'>
        ...
        <Link to='/registration' className='w-auto  flex justify-center items-center px-2 hover:px-6 border-green-600'>Join</Link>
      </div>
