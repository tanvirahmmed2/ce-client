...
const Sidebar = () => {
  ...
  console.log(sidebar)
  return (
    <div className={`w-[250px] min-h-screen fixed bg-gray-500 z-50 right-0 flex ${sidebar ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-500 ease-in-out flex-col items-end justify-start gap-4 text-white px-6 py-6`}>
