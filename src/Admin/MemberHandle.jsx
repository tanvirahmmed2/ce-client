  ...
  return (
    <div className='w-full flex flex-col items-center justify-center gap-6'>
      ...
      <div className='w-full flex flex-col items-center justify-center gap-4'>
        ...
        <div className='w-full grid grid-cols-4 gap-2 border-b-2 p-4 justify-items-center'>
          <p>From</p>
          <p>Subject</p>
          <p>Message</p>
          <p>Email</p>
        </div>
        {
          messages && messages.map((e, index) => {
            ...
            return <div key={index} className='w-full grid grid-cols-4 gap-2 border-b-2 p-2 shadow-sm hover:shadow-md transition duration-500 justify-items-center'>
